...
public class FastHopperRecipe extends SpecialCraftingRecipe {
    public FastHopperRecipe(Identifier identifier) { super(identifier); }
    ...
    @Override
    public ItemStack craft(CraftingInventory inv) { return new ItemStack(Main.FAST_HOPPER_BLOCK.asItem()); }
    ...
    public RecipeSerializer<?> getSerializer() {
        return Main.FAST_HOPPER_RECIPE_SERIALIZER;
    }
}
