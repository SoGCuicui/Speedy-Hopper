...
public class Main implements ModInitializer {
	...
	public static BlockEntityType<FastHopperBlockEntity> FAST_HOPPER_BLOCK_ENTITY;// = BlockEntityType.Builder.create(FastHopperBlockEntity::new, FAST_HOPPER_BLOCK).build(null);
	...
	public static BlockEntityType<SlowHopperBlockEntity> SLOW_HOPPER_BLOCK_ENTITY;// = BlockEntityType.Builder.create(SlowHopperBlockEntity::new, SLOW_HOPPER_BLOCK).build(null);
	...
	public void onInitialize() {
		...
		FAST_HOPPER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, FAST_HOPPER_ENTITY_ID, FabricBlockEntityTypeBuilder.create(FastHopperBlockEntity::new, FAST_HOPPER_BLOCK).build(null));
		...
		SLOW_HOPPER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, SLOW_HOPPER_ENTITY_ID, FabricBlockEntityTypeBuilder.create(SlowHopperBlockEntity::new, SLOW_HOPPER_BLOCK).build(null));
